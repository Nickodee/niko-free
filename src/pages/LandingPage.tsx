...
export default function LandingPage({
  ...
  const adConfig = {
    ...
    description:
      "Get 30% off on all premium events this month. Use code PREMIUM30 at checkout.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 transition-colors duration-200 relative">
      ...
      <div
        className="hidden dark:block fixed inset-0 pointer-events-none z-0"
        style={{
          backgroundImage:
        ...
        <div className="relative h-[550px] sm:h-[570px] md:h-[620px] lg:h-[680px] xl:h-[720px] overflow-hidden">
          ...
          <div className="relative h-full flex flex-col justify-between py-3 sm:py-4 md:py-6">
            ...
            <div className="relative z-[60]">
              <div
                className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-1 md:py-1.5"
                data-aos="fade-down"
              >
                <div ref={searchContainerRef} className="relative">
                  ...
                  <div
                    className={`${
                      isSearchExpanded ? "block" : "hidden md:flex"
                    } flex-col md:flex-row items-stretch md:items-center bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-xl md:rounded-full border border-gray-200 dark:border-gray-700 p-1.5 gap-1.5 transition-colors duration-200 shadow-xl`}
                  >
                    ...
                    <button
                      ...
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.backgroundColor = "#1a8ec4")
                      }
                      onMouseLeave={(e) =>
        ...
        <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="relative">
            {isLoadingEvents ? (
              ...
              <div
                ref={cantMissRef}
                className="overflow-x-auto scrollbar-hide hide-scrollbar snap-x snap-mandatory"
              >
          ...
          <div className="hidden md:block">
            <div className="relative">
                      ...
                      >
                        ...
                        <span
                          className={`text-sm mb-1 text-center whitespace-nowrap ${
                            isSelected
                              ? "font-bold text-gray-900 dark:text-white"
                              : "font-medium text-gray-900 dark:text-gray-300 group-hover:font-bold"
                          }`}
                        >
                          {category.displayName || category.name}
                        </span>
                        <span className="text-xs text-gray-500 dark:text-gray-400 text-center whitespace-nowrap">
                          {category.count} events
                        </span>
                        <span
                          className={`absolute left-3 right-3 bottom-0 h-1 rounded-full ${
                            isSelected ? "" : "bg-gray-200 dark:bg-gray-700"
                          }`}
                          style={
                            isSelected ? { backgroundColor: "#27aae2" } : {}
                          }
                        />
                      </button>
                    );
              ...
              <button
                ...
                className={`absolute left-0 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white shadow-lg hover:bg-gray-50 transition-all ${
                  showLeftArrow
                    ? "opacity-100"
                    : "opacity-0 pointer-events-none"
                }`}
